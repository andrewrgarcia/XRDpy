...
''' an algorithm for adding a flat baseline (values of zero) to an array
with non-zero values [helps to computationally construct "peaks" from
reflection parameters obtained from processed .cif files]
Andrew Garcia, 2018
'''
X=[]

with open( 'XRD_files/Book1.csv' , 'r') as f:
